...
export default function ManageWithdrawPassword() {
  return (
    <>
      <label
        htmlFor="manageWithdrawPassword"
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm md:text-base">Kelola Kata Sandi Penarikan</p>
        </div>
      ...
      <input
        type="checkbox"
        id="manageWithdrawPassword"
        className="modal-toggle"
      />
      <div className="modal" role="dialog">
        <div className="modal-box">
          <h3 className="text-lg font-bold mb-4">
            Kelola Kata Sandi Penarikan
          </h3>
